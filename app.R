...
pred_all_rook<- read.csv("https://raw.githubusercontent.com/Ariadna436JR/CICESE_ULP_MEM/main/pred_all_rook_CSL.csv")
sum_count_predict<- read.csv("https://raw.githubusercontent.com/Ariadna436JR/CICESE_ULP_MEM/main/pred_total_pop_CSL.csv")
